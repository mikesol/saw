...
mezzo = \relative c' {
  ...
  c8-. r4 c8 ~ \times 2/3 { c g gis a ais b } |
  c e c a bes d bes g |
  a c a f ~ f4 d |
  ...
  %f bes f ees \times 2/3 { d bes c d f g } |
  %bes4 g r g |
...
\score {
  \new ChoirStaff <<
   ...
   \repeat unfold 372 \unfoldSwing #96
