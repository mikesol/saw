...
soprano = {
  \relative c'' { 
    ...
    \lo aes \sh aes \lo aes \sh f ~ \lo f \sh f \lo r \sh f |
...
mezzo = {
  \relative c' {
    ...
    \lo ees \sh ees r4 r2 |
    \lo r8 \sh des^\mp \lo des \sh des \lo c \sh r r4 |
    ...
    \lo f \sh f \lo f \sh c ~ \lo c \sh c \lo r \sh c |
...
tenor = {
  ...
  \relative c {
    ...
    \lo c \sh d \lo r \sh ees ~ \lo ees \sh aes, \lo r \sh aes |
    \lo g \sh g g4 aes f |
    ees8. g g g g4-. |
  }
}
