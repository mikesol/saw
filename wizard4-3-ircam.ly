...
marksTen = {
  s4
  s2. \break
  \repeat unfold 14 { \repeat unfold 4 {s2. } \break }
}
...
\markup {
  \fill-line {
    \score {
     <<
     \new Staff \new Voice = "sop" << { \soprano } { \marks } >>
     \new Lyrics \lyricsto "sop" \sopranoWords
     >>
     \layout { line-width=#70 }
     }
    \score {
     <<
     \new Staff \new Voice = "ten" << { \tenorExperimental } { \marks } { \marksTen } >>
     \new Lyrics \lyricsto "ten" \tenorWords
     >>
     \layout { line-width=#70 }
     }
  }
