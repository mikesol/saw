...
mezzo = \relative c'' {
  ...
  c4 \times 2/3 { r8 c'8 bes } aes8 g f ees |
  d8. d'16   c bes aes g   f ees ees ees    ees ees g aes |
  bes g ees f g ees8 f16 g ees c d ees c8 ees16 |
  %bes g ees f g ees4 f8 |
  %g ees c d ees4 ees |
}
